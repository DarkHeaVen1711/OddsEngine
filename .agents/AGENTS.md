...
- **Micro Commits (<100)**: Make small, incremental micro-commits. Each commit must contain fewer than 100 lines/changes.
- **Commit Topologies**: Structure commits logically to build clean, descriptive branch topologies that tell a clear history.
